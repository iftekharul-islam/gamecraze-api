...
class TransactionHistoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = User::join('lenders', 'users.id', '=', 'lenders.renter_id')
            ->selectRaw('SUM(lend_cost) as amount, SUM(discount_amount) as discount_amount, SUM(commission) as commission, SUM(original_commission) as original_commission, renter_id, users.name, users.last_name, users.id')
        ...
        foreach ($data as $item) {
            ...
            $seller_amount += $item->amount + $item->discount_amount + $item->commission - $item->original_commission;
