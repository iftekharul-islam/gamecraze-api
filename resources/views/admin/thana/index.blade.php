                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('thana.create') }}" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Thana</a>
                            </div>
                            <div class="card-body">
                                @if (count($thanas) > 0)
