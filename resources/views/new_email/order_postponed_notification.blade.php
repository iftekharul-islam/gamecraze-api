...
@section('content')
    ...
    <tr>
        <td style="padding-left: 80px; padding-right: 80px">
            <p>
                Thanks for trusting GameHub. Your order of renting {{ $order->order_no }} is postponed due occupied lender's account. Someone from our team will call you soon with the expected date of delivery.
            </p>
